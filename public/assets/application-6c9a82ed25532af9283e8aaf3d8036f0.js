	...
	$.extend(true, $.avatar_loading, {
		...
		init: function(loadingDiv) {
			...
			if ( $(loadingDiv).length == 0) { 
				...
				container.innerHTML = "<img src=/assets/profile/avatar_loading.gif alt=Loading>";
			}
	...
	$.extend(true, $.full_loading, {
		...
		init: function() {
			...
			if ( $('.full_loading').length == 0) { 
				...
				container.innerHTML = "<img src=/assets/spinner.gif alt=Processing>Processing";
			}
...
$("#lean_overlay").css({"display":"block",opacity:0});$("#lean_overlay").fadeTo(200,o.overlay);$(modal_id).css({"display":"block","position":"fixed","opacity":0,"z-index":11000,"left":50+"%","margin-left":-(modal_width/2)+"px","top":o.top+"px"});$(modal_id).draggable({ handle: ".title" });$(modal_id).fadeTo(200,1);e.preventDefault()})});function close_modal(modal_id){$("#lean_overlay").fadeOut(200);$(modal_id).css({"display":"none"})}}})})(jQuery);
